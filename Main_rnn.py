# -*- coding: utf-8 -*-
"""
Created on Tue Dec 14 13:26:01 2021
...
"Visulaize the data will be used"
df_visualization(df)
df_visualization(to_attack)


"Check for Nan data and replace it with the median"
df = df_processing(df)
...
"Create Benign Data"
#df = pd.concat([d1,d2,d3,d4]).iloc[0:,1:-1]
B = df.to_numpy()
print('Thr shape of benign inputs : ',B.shape)
...
print('Thr shape of adverserial inputs : ',mA.shape)
